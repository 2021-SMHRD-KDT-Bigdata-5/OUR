...
<body class="is-preload">
	...
	<%
		String connUser = (String)session.getAttribute("connUser"); // 오브젝트 타입 > 스트링 타입으로 다운 캐스띵
	%>
	<!-- Wrapper -->
	<div id="wrapper">
		...
		<nav id="menu">
			<ul class="links">
				...
				<li><a href="landing.html">화면공유</a></li>
				<li><a href="generic.html">자료실</a></li>
				<li><a href="elements.html">수준별 학습</a></li>
			</ul>
		</nav>
			...
			<div class="inner">
				...
				<div class="content">
					...
					<ul class="actions">
						<%
							if (connUser == null) {
								out.print("<li><a href='login.html' class='button next scrolly'>지금 시작</a></li>");
							}else {
								out.print("<li><a href='#menu' class='button next scrolly'>지금 시작</a></li>");
							}
						%>
					</ul>
				</div>
		...
		<div id="main">
			...
			<section id="one" class="tiles">
				<article>
					...
					<header class="major">
						<h3><a href="landing.html" class="link">화면공유</a></h3>
				...
				<article>
					...
					<header class="major">
						<h3><a href="landing.html" class="link">자료실</a></h3>
				...
				<article>
					...
					<header class="major">
						<h3><a href="landing.html" class="link">수준별 학습</a></h3>
